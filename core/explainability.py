...
def build_explainability(
    ...
    # =========================================================================
    # 3. CONFLICTING EVIDENCE & MULTI-VECTOR THREAT DETECTION
    # =========================================================================
    if (
    ...
    if (
        risks.context_risk is not None
        and risks.deepfake_risk is not None
    ):
        if risks.context_risk >= HIGH_THRESHOLD and risks.deepfake_risk <= LOW_THRESHOLD:
            reasons.append(
